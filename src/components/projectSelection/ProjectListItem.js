...
function ProjectListItem({ project }) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(core_1.Grid, { p: 'xs', sx: (theme) => ({
            ...
            react_1.default.createElement(core_1.Grid.Col, { span: "auto", onClick: () => { window.electronAPI.openProject(project.id); } },
            ...
            react_1.default.createElement(core_1.Grid.Col, { span: 2 },
                react_1.default.createElement(core_1.Group, { position: 'right' },
                    ...
                    react_1.default.createElement(core_1.ActionIcon, { color: 'gray', variant: 'subtle', size: 20, onClick: () => { setDeleteModal(true); } },
