...
function Atom({ contentsBeingDragged, atom, projectID }) {
    ...
    return isDragging ? (React.createElement(core_1.Container, { ref: drag, id: id, style: getAtomStyles(contentsBeingDragged, theme, atomShape, isDragging, left, top, atomColor), shadow: "md" },
        React.createElement(AtomContents_1.AtomContents, { id: id, sourceAtomKey: sourceAtomKey, projectKey: projectKey, testKey: testKey, left: left, top: top }))) : (React.createElement(core_1.Container, { ref: drag, id: id, style: getAtomStyles(contentsBeingDragged, theme, atomShape, isDragging, left, top, atomColor), shadow: "md" },
        React.createElement(AtomContents_1.AtomContents, { id: id, left: left, top: top, sourceAtomKey: sourceAtomKey, projectKey: projectKey, testKey: testKey })));
}
exports.Atom = Atom;
