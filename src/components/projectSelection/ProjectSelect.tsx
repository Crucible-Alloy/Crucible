...
import { AppShell, Burger, Header, MediaQuery, Navbar, Text, Title, Footer, useMantineTheme, ActionIcon, Stack, Group,
         Button, Loader, Center, ScrollArea } from "@mantine/core";
