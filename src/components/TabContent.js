...
const TestPlayBtn_1 = __importDefault(require("./TestPlayBtn"));
...
function TabContent({ test, projectID, mousePos }) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(core_1.Group, { style: {
                position: "absolute",
                top: 80,
                left: 40,
                margin: "16px",
            ...
            react_1.default.createElement(TestPlayBtn_1.default, { projectID: projectID, testID: test.id, disabled: false }),
