...
// //     let pathArray = ( process.platform === 'win32') ? data.alloyFile.split('\\') : data.alloyFile.split('/')
// //     // Send file to alloy API and get back metadata
// //     const apiRequest = axios.post("http://localhost:8080/files",  {
// //       filePath: pathArray, operatingSystem: process.platform }, {headers: {
